...
!(function (t, e) {
                ...
                if (s.length) {
                    ...
                    for (
                        ...
                        (n = s[t]._view),
                            ...
                            n.skip ||
                                ((d !== t - 1 && !o) || -1 === d ? r.moveTo(n.x, n.y) : B.canvas.lineTo(r, e._view, n),
                                (d = t));
    ...
    var Jt = at.extend({
        ...
        _resolveDatasetElementOptions: function () {
            ...
            return (
                (i.spanGaps = Kt(e.spanGaps, n.spanGaps)), (i.tension = Kt(e.lineTension, n.elements.line.tension)), i
            );
        },
        updateBezierControlPoints: function () {
            var t,
            ...
            e.exports = (function () {
                ...
                return (
                    ...
                    (a.relativeTimeThreshold = function (t, e) {
                        return (
                            void 0 !== ti[t] && (void 0 === e ? ti[t] : ((ti[t] = e), 's' === t && (ti.ss = e - 1), !0))
                        );
                    }),
        ...
        for (t.beginPath(), o = 0, s = g; o < s; ++o)
            (d = n((u = e[(l = o % g)]._view), l, i)),
                ...
                h && c
                    ...
                    : b &&
                      y &&
                      (m ? (h && p.push(u), c && v.push(d)) : (ki(t, p, v, b, y), (b = y = 0), (p = []), (v = [])));
