                        ...
                        'flex' === i.barThickness
                            ? (function (t, e, n) {
                                  ...
                                  return (
                                      null === o &&
                                          (o =
                                              r - (null === s ? e.end - e.start : s - r)),
                                      null === s && (s = r + r - o),
                                      (i = r - ((r - Math.min(o, s)) / 2) * l),
                                      {
                                          chunk:
                                              ((Math.abs(s - o) / 2) * l) / e.stackCount,
                            ...
                            case 'hour':
                                (e = this._d.valueOf()),
                                    (e +=
                                        dn -
                                        cn(
                                            e + (this._isUTC ? 0 : this.utcOffset() * un),
                                            dn,
                                        ) -
                                        1);
                                break;
                ...
                return (
                    ...
                    (ri.as = function (t) {
                        ...
                        if ('month' === (t = R(t)) || 'quarter' === t || 'year' === t)
                            ...
                            switch (
                                ((e = this._days + Math.round(Ln(this._months))), t)
                            ) {
                                case 'week':
                                    return e / 7 + i / 6048e5;
                                case 'day':
